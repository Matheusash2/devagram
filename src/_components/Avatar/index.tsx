...
const Avatar = (props: { withLinearGradient?: boolean,  user: IUserData | IUser}) => {
...
const navigation = useNavigation<navigationTypes>();
  return (
     ...
     <LinearGradient colors={[colors.primaryColor1, colors.primaryColor2]} style={styles.avatarGradient}>
      {props.user.avatar ? (
